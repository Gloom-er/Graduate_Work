        ...
        <div class="nav-main">
            <div class="container">
                ...
                <div class ="nav-list">
                    ...
                    <div class="nav-item active"><a href="" class="nav-item-link"><span><i class="fas fa-cogs"></i>Услуги</a></span></div>
    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href=""><span class="main-span ">Автоперевозка</span></a>
                            <a href=""><span class="main-span ">Авиаперевозка</span></a>
                            <a href=""><span class="main-span active">Доп. услуги</span></a>
                            <a href=""><span class="second-span ">Забор и доставка груза</span><br></a>
                            <a href=""><span class="second-span">Погрузочно-разгрузочные работы</span><br></a>
                            <a href=""><span class="second-span">Упаковка</span><br></a>
...
if(!empty($_POST)){ 
    ...
    $adres=$_POST['add2'];
    $adres2=$_POST['add3'];
$query="INSERT INTO avia SET name='$name',transport='$transport', adresot='$adres', adresdost='$adres2'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM avia where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM avia WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
