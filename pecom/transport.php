    ...
    <nav id="navigation" class="nav">
        <div class="nav-main">
            <div class="container">
                ...
                <div class ="nav-list">
                    <div class="nav-item active"><a href="" class="nav-item-link"><span><i class="fas fa-car"></i>Транспорт</span></a></div>
    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                    <div class="">
                        <a href=""><span class="main-span active">Автотранспорт</span></a>
                            <a href=""><span class="second-span ">Топливо</span><br></a>
                            <a href=""><span class="second-span">Водитель</span><br></a>
                            <a href=""><span class="second-span">Прицеп</span><br></a>
                            <a href=""><span class="main-span">Авиатранспорт</span></a>
                    </div>
                </div>
                <div class="workspace">
...
if(!empty($_POST)){ 
$name=$_POST['add'];
$query="INSERT INTO fuel SET name='$name'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM fuel where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM fuel WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
...
/*         $result.='<td><a href="unreg.php?edit_id=' . $elem['id'] . '"><button type=button>Редактировать</button></a></td>'; */
        $result.='</tr>';
    }
    echo $result;
?>
