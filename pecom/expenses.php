    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="zp.php"><span class="main-span ">Зарплата</span></a>
                            <a href="income.php"><span class="main-span ">Доходы</span></a>
                            <a href="expenses.php"><span class="main-span active">Расходы</span></a>
                ...
                <div class=high-add>
                        ...
                        <input class ="add" name="add1" placeholder="Источник">
...
if(!empty($_POST)){ 
    ...
    $source=$_POST['add1'];
    $data=$_POST['add2'];
$query="INSERT INTO expenses SET name='$name',source='$source', data='$data'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM expenses where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM expenses WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
