        ...
        <div class="nav-main">
            <div class="container">
                ...
                <div class="nav-item "><a href="autotransport.php" class="nav-item-link"><span><i class="fas fa-car"></i>Транспорт</span></a></div>
                    ...
                    <div class="nav-item active"><a href="request_phis.php" class="nav-item-link"><span><i class="fas fa-scroll"></i>Заявки</span></a></div>
...
?></span></a>
    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            <h1 class ="top">Заявки</h1>
            <div class="layout-side">
                <div class="sidebar">
                        <a href="request_phis.php"><span class="main-span active">Физ лица</span></a>
                            <a href="request_ur.php"><span class="main-span">Юр лица</span></a>
                            <a href="request_gos.php"><span class="main-span">Государство</span></a>
                ...
                <div class=high-add>
                        ...
                        <input class ="add" name="add1" placeholder="Услуга">
                        <input class ="add" name="add2" placeholder="Дата">
...
$service=$_POST['add1'];
$data=$_POST['add2'];
$query="INSERT INTO phis SET name='$name',service='$service', data='$data'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM phis where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM phis WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
