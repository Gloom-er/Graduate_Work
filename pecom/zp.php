        ...
        <div class="nav-main">
            <div class="container">
                ...
                <div class="nav-item "><a href="autotransport.php" class="nav-item-link"><span><i class="fas fa-car"></i>Транспорт</span></a></div>
                    ...
                    <div class="nav-item active"><a href="zp.php" class="nav-item-link"><span><i class="fas fa-coins"></i>Финансы</span></a></div>
...
?></span></a>
    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            <h1 class ="top">Финансы</h1>
            <div class="layout-side">
                <div class="sidebar">
                        <a href="zp.php"><span class="main-span active">Зарплата</span></a>
                            <a href="income.php"><span class="main-span ">Доходы</span></a>
                            <a href="expenses.php"><span class="main-span ">Расходы</span></a>
                ...
                <div class=high-add>
                        <form method="POST">
                        <input class ="add" name="add" placeholder="Имя Ф.О. сотрудника">
                        <input class ="add" name="add1" placeholder="Сумма">
...
if(!empty($_POST)){ 
    ...
    $summa=$_POST['add1'];
    $data=$_POST['add2'];
$query="INSERT INTO zp SET name='$name',summa='$summa', data='$data'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM zp where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM zp WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
