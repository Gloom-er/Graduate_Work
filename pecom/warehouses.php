    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="warehouses.php"><span class="main-span active">Предприятие</span></a>
                            <a href="warehouses2.php"><span class="main-span">Партнеры</span></a>
...
$tip=$_POST['add1'];
$ploshad=$_POST['add2'];
$query="INSERT INTO sclad SET adres='$adres',tip='$tip', ploshad='$ploshad'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM sclad where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM sclad WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
