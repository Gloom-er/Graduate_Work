        ...
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                ...
                <a href="sclad_oborud.php"><span class="main-span ">Складское</span></a>
                            ...
                            <a href="other_oborud.php"><span class="main-span active">Прочее </span></a>
...
if(!empty($_POST)){ 
    ...
    $cost=$_POST['add1'];
    $adres=$_POST['add2'];
$query="INSERT INTO other_oborud SET name='$name',cost='$cost',adres='$adres'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM other_oborud where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM other_oborud   WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
