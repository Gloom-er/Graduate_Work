...
<head>
    ...
    <link rel="stylesheet" href="css/style_request.css" type="text/css">
        ...
        <div class="nav-main">
            <div class="container">
                ...
                <div class="nav-item "><a href="autotransport.php" class="nav-item-link"><span><i class="fas fa-car"></i>Транспорт</span></a></div>
                    ...
                    <div class="nav-item active"><a href="supervisor.php" class="nav-item-link"><span><i class="fas fa-user-tie"></i>Персонал</a></span></div>
...
?></span></a>
    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            <h1 class ="top">Персонал</h1>
            <div class="layout-side">
                <div class="sidebar">
                        <a href="supervisor.php"><span class="main-span active">Руководители</span></a>
                            <a href="Specialist.php"><span class="main-span ">Специалисты</span></a>
                            <a href="employye.php"><span class="main-span ">Служащие</span></a>
                ...
                <div class=high-add>
                        <form method="POST">
                        <input class ="add" name="add" placeholder="Фамилия И.О.">
                        <input class ="add" name="add1" placeholder="Должность">
                        <input class ="add" name="add2" placeholder="Адрес">
...
if(!empty($_POST)){ 
    ...
    $dolzh=$_POST['add1'];
    $adres=$_POST['add2'];
$query="INSERT INTO supervisor SET name='$name',dolzh='$dolzh', adres='$adres'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM supervisor where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM supervisor WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
