            ...
            <div class="layout-side">
                <div class="sidebar">
                    ...
                    <a href="autotransport.php"><span class="main-span ">Автотранспорт</span></a>
                            ...
                            <a href="pricep.php"><span class="second-span active">Прицеп</span><br></a>
                ...
                <div class="workspace">
                    ...
                    <div class=high-add>
                        <form method="POST">
                        <input class ="add" name="add" placeholder="Название прицепа">
...
if(!empty($_POST)){ 
$name=$_POST['add'];
$query="INSERT INTO pricep SET name='$name'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM pricep where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM pricep WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
