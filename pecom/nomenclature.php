    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="nomenclature.php"><span class="main-span active">Номенклатура</span></a>
                            <a href="waybill.php"><span class="main-span ">Путевые листы</span></a>
                ...
                <div class=high-add>
                        ...
                        <input class ="add" name="add1" placeholder="Срок хранения">
                        <input class ="add" name="add2" placeholder="Примечание">
...
if(!empty($_POST)){ 
    ...
    $term=$_POST['add1'];
    $note=$_POST['add2'];
$query="INSERT INTO nomenclature SET name='$name',term='$term', note='$note'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM nomenclature where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM nomenclature WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
