        ...
        <div class="nav-main">
            <div class="container">
                ...
                <div class="nav-item "><a href="autotransport.php" class="nav-item-link"><span><i class="fas fa-car"></i>Транспорт</span></a></div>
                    ...
                    <div class="nav-item active"><a href="sclad_oborud.php" class="nav-item-link"><span><i class="fas fa-plug"></i>Оборудование</a></span></div>
                </div>
                <div class="nav-items">
...
?></span></a>
    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            <h1 class ="top">Оборудование</h1>
            <div class="layout-side">
                <div class="sidebar">
                <a href="sclad_oborud.php"><span class="main-span ">Складское</span></a>
                            <a href="park_oborud.php"><span class="main-span ">Парковое</span></a>
                            <a href="office_oborud.php"><span class="main-span active">Офисное </span></a>
                            <a href="other_oborud.php"><span class="main-span ">Прочее </span></a>
                ...
                <div class=high-add>
                        ...
                        <input class ="add" name="add1" placeholder="Стоимость">
...
if(!empty($_POST)){ 
    ...
    $cost=$_POST['add1'];
    $adres=$_POST['add2'];
$query="INSERT INTO office_oborud SET name='$name',cost='$cost',adres='$adres'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM office_oborud where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM office_oborud WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
