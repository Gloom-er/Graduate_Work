    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="sclad_oborud.php"><span class="main-span active">Складское</span></a>
                            <a href="park_oborud.php"><span class="main-span ">Парковое</span></a>
                            <a href="office_oborud.php"><span class="main-span ">Офисное </span></a>
...
if(!empty($_POST)){ 
    ...
    $cost=$_POST['add1'];
    $adres=$_POST['add2'];
$query="INSERT INTO sclad_oborud SET name='$name',cost='$cost',adres='$adres'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM sclad_oborud where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM sclad_oborud WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
