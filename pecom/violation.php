        ...
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                ...
                <a href="nomenclature.php"><span class="main-span ">Номенклатура</span></a>
                            ...
                            <a href="violation.php"><span class="main-span active">Нарушения </span></a>
                ...
                <div class=high-add>
                        ...
                        <input class ="add" name="add1" placeholder="Дата">
                        <input class ="add" name="add2" placeholder="Номер">
...
if(!empty($_POST)){ 
    ...
    $data=$_POST['add1'];
    $number=$_POST['add2'];
$query="INSERT INTO violation SET name='$name',data='$data', number='$number'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM violation where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM violation WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
