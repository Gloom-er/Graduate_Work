            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="trucking.php"><span class="main-span ">Автоперевозка</span></a>
                            ...
                            <a href="packaging.php"><span class="second-span active">Упаковка</span><br></a>
                ...
                <div class=high-add>
                        ...
                        <input class ="add" name="add1" placeholder="Вид упаковки">
                        <input class ="add" name="add2" placeholder="Сумма">
                        <input class ="add" name="add3" placeholder="Дата">
...
if(!empty($_POST)){ 
    ...
    $summa=$_POST['add2'];
    $data=$_POST['add3'];
$query="INSERT INTO packaging SET name='$name',vid='$vid', summa='$summa', data='$data'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM packaging where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM packaging WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
