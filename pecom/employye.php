    ...
    <div class = "page">
        <div id="page" class="page-wrapper">
            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="supervisor.php"><span class="main-span ">Руководители</span></a>
                            <a href="Specialist.php"><span class="main-span ">Специалисты</span></a>
                            <a href="employye.php"><span class="main-span active">Служащие</span></a>
...
if(!empty($_POST)){ 
    ...
    $dolzh=$_POST['add1'];
    $adres=$_POST['add2'];
$query="INSERT INTO employye SET name='$name',dolzh='$dolzh', adres='$adres'";
mysqli_query($link, $query) or die(mysqli_error($link));
}
if(isset($_GET['del'])){
    $del=$_GET['del'];
    $query="DELETE FROM employye where id=$del";
    mysqli_query($link, $query) or die(mysqli_error($link));
    }
    $query="SELECT * FROM employye WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
