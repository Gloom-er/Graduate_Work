            ...
            <div class="layout-side">
                <div class="sidebar">
                        <a href="supervisor.php"><span class="main-span ">Руководители</span></a>
                            <a href="specialist.php"><span class="main-span active">Специалисты</span></a>
...
if(!empty($_POST)){ 
    ...
    $dolzh=$_POST['add1'];
    $adres=$_POST['add2'];
$query="INSERT INTO specialist SET name='$name',dolzh='$dolzh', adres='$adres'";
...
if(isset($_GET['del'])){
    ...
    $query="SELECT * FROM specialist WHERE id > 0";
    $result=mysqli_query($link,$query) or die(mysqli_error($link));
    for($data=[];$row=mysqli_fetch_assoc($result);$data[]=$row);
    $result='';
    foreach($data as $elem){
